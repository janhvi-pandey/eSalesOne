...
//   const isMatch =
//     ccLast4 === last4 ||
//     (fullCardNumber && fullCardNumber.endsWith(last4));

//   console.log("Comparing last4:", last4);
//   console.log("cc_last_4:", ccLast4);
//   console.log("credit_card_number:", fullCardNumber);
...
export async function getCustomerIdFromOrder(orderId, last4) {
  ...
  console.log("c", data); // Also flat response, not nested
